...
<html lang="pt-br">
	...
	<body id="page-top">
    <input type='text' name='pjhid' id='pjhid' value='<?php echo $_SESSION['main']['user']; ?>'>
    ...
    <section id="register">
      <div class="container" style="padding-top: 30px">
        <h2 class="text-center text-uppercase text-secondary mb-0">MEUS RELATÓRIOS</h2>
            ...
            <form id="fnewcoleta" name="fnewcoleta">
              <div class="control-group float-left col-lg-6 ">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  ...
                  <input class="form-control" id="dataini" name="dataini" type="date" placeholder="DATA INICIAL" required="required" data-validation-required-message="Por favor informe: dia preferencial.">
              ...
              <div class="control-group float-left col-lg-6">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  ...
                  <input class="form-control" id="datafim" name="datafim" type="date" placeholder="DATA FINAL" required="required" data-validation-required-message="Por favor informe: dia preferencial.">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              <div class="form-group text-center">
                <button type="button" name="relatoriosubmit" class="btn btn-primary btn-xl col-md-6" id="relatoriosubmit">Gerar Relatório</button>
              </div>
            </form>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12 mx-auto text-center">
            <table id="tbl-dash-relatorio" class="table table-striped table-hover">
                <?php if(isset($_SESSION['main']['report']) && !empty($_SESSION['main']['report'])){
                  print($_SESSION['main']['report']);
                } 
                ?>
              </table>
          </div>
