...
<html lang="pt-br">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="index.php">Painel</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
    ...
    <section id="register">
      <div class="container" style="padding-top: 30px">
        <h2 class="text-center text-uppercase text-secondary mb-0">PAINEL PRINCIPAL</h2>
        ...
        <div class="row">
          ...
          <!--<table class="table table-bordered">
            <thead>
                <tr>
                  <th>MINHAS COLETAS</th>
                </tr>
              </thead>
          </table>-->

            <table id="tbl-dash" class="table table-striped table-hover">
              <?php if(isset($_SESSION['main']['user']) && isset($_SESSION['main']['dt'])){
                $dt  = $_SESSION['main']['dt'];
                $usr = $_SESSION['main']['user'];
                //print($_SESSION['main']['table'][$dt][$usr]);
                print($_SESSION['main']['table']['default'][$dt][$usr]);
              }else{
                header('Location: ../');
              } ?>
              </table>
